                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Device
                                </li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-content ">
                                    <div class="card-body card-dashboard">
                                        <div class="table-responsive">
                                            <table id="tbl_device" class="table table-hover table-bordered table-striped tbl_device" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>#</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form id="frm_mainte_adddevice" class="form form-horizontal frm_mainte_adddevice" method="post" action="action_maintenance.php" autocomplete="off">
                            <input type="hidden" name="input_maintedevice" id="input_maintedevice">
                            <div class="form-body">
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="text_1">Device ID</label>
                                    <div class="col-md-9 mx-auto">
                                        <input type="text" id="text_1" name="text_1" class="form-control capitalizefletter" placeholder="Device ID" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="text_2">Device Name</label>
                                    <div class="col-md-9 mx-auto">
                                        <input type="text" id="text_2" name="text_2" class="form-control capitalizefletter" placeholder="Device Name" >
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 label-control" for="text_3">Campus</label>
                                    <div class="col-md-9 mx-auto">
                                        <select class="form-control sel_eventcampus select2" name="text_3" id="text_3">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" class="btn btn-outline-primary" value="Save Device">
                </div>
                </form>
            </div>
        </div>
...
<!-- 
    ...
    <!-- END: Content-->
        ...
        <script src="../js/maintenance_device.js"></script>
<!-- END: Body-->
